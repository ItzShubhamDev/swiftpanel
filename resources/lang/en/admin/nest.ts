export default {
  ...
  eggs: {
    notices: {
      ...
      script_updated:
        'Egg install script has been updated and will run whenever servers are installed.',
      egg_created:
  ...
  variables: {
    notices: {
      variable_deleted:
        'The variable ":variable" has been deleted and will no longer be available to servers once rebuilt.',
      variable_updated:
        'The variable ":variable" has been updated. You will need to rebuild any servers using this variable in order to apply changes.',
